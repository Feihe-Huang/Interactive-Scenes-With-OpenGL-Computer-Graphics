...
public class Player {
	...
	public Player(Texture texture, Texture texture_1, Texture texture_2, Texture texture_3, Texture texture_4, Texture texture_5, Texture texture_6) {
	...
	public void drawPlayer(float delta, float handMove, boolean justTalk, boolean startRun, boolean startRocket, boolean startDrink, boolean startCheers, boolean startJump, boolean startWave)
	{
